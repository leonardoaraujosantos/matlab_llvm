...
| `ode_solver.m` | `ode45` / `ode23` — scalar and **vector `y`**, 2-element and user-grid `tspan`, `odeset` (`RelTol`, `AbsTol`, `MaxStep`, `Refine`, `Stats`), backward-time integration, 3-return `[t, y, stats]` |
