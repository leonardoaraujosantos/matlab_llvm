...
% Constraint container — pose target on the end-effector.
classdef constraintPoseTarget
    properties
        TargetTransform matrix   % 4×4
        Weights matrix           % 1×6  [orientation_x .. position_z]
    end
    methods
...
% collisionBox — axis-aligned-bounding-box geometry primitive.
...
% collisionSphere — sphere geometry primitive.
