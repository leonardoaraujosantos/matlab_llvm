...
[![Run-tests](https://img.shields.io/badge/run--tests-465_%E2%9C%93-2EA44F.svg)](test/Run)
...
calls into. Sixteen toolbox surfaces ship today:
...
**Planned next toolboxes** — five more have full tiered compatibility
roadmaps drafted (not yet shipped), ordered by gain (demand × reuse of
the shipped substrate):
[Curve Fitting](docs/curve_fitting_toolbox_roadmap.md) (cheapest — rides
`polyfit`/`interp1` + the shipped Optim `lsqcurvefit`/`lsqnonlin`),
